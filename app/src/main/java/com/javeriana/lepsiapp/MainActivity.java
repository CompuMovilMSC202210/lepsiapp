...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("Usuarios").child(uid).child("rol").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    String rol_main = snapshot.getValue().toString();
                    Toast.makeText(MainActivity.this,rol_main, Toast.LENGTH_LONG).show();
