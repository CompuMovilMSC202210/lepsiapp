 ...
 * Use the {@link specific_chat#newInstance} factory method to
...
public class specific_chat extends Fragment {
    ...
    public static specific_chat newInstance(String param1, String param2) {
        specific_chat fragment = new specific_chat();
